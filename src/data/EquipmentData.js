// data/EquipmentData.js (V0.9.5) — base de données STATIQUE du loadout IRL du joueur (Bottes, Corps,
// Kit PCC). Purement des données: aucune logique ici (cf. systems/player/PlayerLoadout.js pour les
// calculs). weightKg compte contre BALANCE.loadout.maxWeightKg ; stepEfficiencyMult multiplie la
// distance chirale couverte par pas IRL (appliqué exclusivement par RaidSystem.js, jamais ici).
export const BOOTS_DATA = {
      none: { id: 'none', slot: 'boots', name: 'Pieds nus', icon: '🦶', weightKg: 0, stepEfficiencyMult: 1.0, cost: 0 },
      reinforced: { id: 'reinforced', slot: 'boots', name: 'Bottes renforcées', icon: '👢', weightKg: 1.5, stepEfficiencyMult: 1.08, cost: 200 },
      chiral: { id: 'chiral', slot: 'boots', name: 'Bottes Chirales', icon: '✨', weightKg: 1.2, stepEfficiencyMult: 1.18, cost: 600 }
    };
